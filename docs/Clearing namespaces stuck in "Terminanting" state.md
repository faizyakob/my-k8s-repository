...
🚧 The method in this article is a band-aid solution to quickly remove stuck namespaces. If same issue keeps re-occuring, there is a possibility that something else is broken in the cluster. For my cluster at least, I have documented the journey of finding the real cause of the issue at [ Troubleshooting: Unable to delete namespaces ](./Troubleshooting%3A%20Unable%20to%20delete%20namespaces.md). Do pay a visit if interested. 😸
